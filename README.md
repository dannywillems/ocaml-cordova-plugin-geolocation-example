...
This is an example of the binding to the *geolocation cordova plugin*. See the
binding [here](https://github.com/dannywillems/ocaml-cordova-plugin-geolocation)
...
* init_plugins: initialize plugins you need. Contains cordova-plugin-geolocation
  for this project.
